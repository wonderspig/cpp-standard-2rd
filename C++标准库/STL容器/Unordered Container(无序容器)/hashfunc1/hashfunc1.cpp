...
int main()
{
    ...
    unordered_set<Customer,CustomerHash,CustomerEqual> custset; //创建容器，元素类型为Customer

    custset.insert(Customer("nico","josuttis",42)); //插入一个元素
    PRINT_ELEMENTS(custset); //打印这个容器
